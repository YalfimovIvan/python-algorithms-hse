...
class RunLengthEncodingTest(unittest.TestCase):
    ...
    def test_encode_single_char_serie(self):
        self.assertMultiLineEqual(encode("WWWWWWWWWWWWWWWWWWWW"), "20W")
    ...
    def test_encode_single_char_serie(self):
        self.assertMultiLineEqual(decode("20W"), "WWWWWWWWWWWWWWWWWWWW")
